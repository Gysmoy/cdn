...
/**
 * Convierte una cadena de texto en formato XML en un objeto JSON.
 *
 * @param {string} xml - La cadena de texto en formato XML a convertir.
 * @returns {Object|null} - Un objeto JavaScript que representa la estructura de datos XML o null si se produce un error.
 *
 */
JSON.fromXML = function (xml) {
    try {
        ...
        parseNode(xmlDoc.firstChild, obj);
        return obj;
    } catch (error) {
        console.trace(error);
        return null;
