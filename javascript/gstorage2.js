class gStorage {
    ...
    /**
     * Le permite almacenar y recuperar cualquier tipo de datos en localStorage manteniendo
     * la integridad de su valor, si es objeto, retorna un objeto, si es booleano retorna un
     * booleano
     * @param key - La clave del valor a almacenar.
     * @param value [e7efa9b9-4e0f-0626-5419-6b627e28bbca] - El valor que se almacenará en
    ...
    static local(key, value = 'e7efa9b9-4e0f-0626-5419-6b627e28bbca') {
        if (value != 'e7efa9b9-4e0f-0626-5419-6b627e28bbca') {
            switch (typeof value) {
                case 'undefined':
                    localStorage.setItem(key, `undefined:${value}`);
                    break;
                case 'boolean':
                ...
                case 'string':
                    ...
                    break;
                case 'bigint':
                    localStorage.setItem(key, `bigint:${value}`);
                    break;
                case 'object':
                    localStorage.setItem(key, `object:${JSON.stringify(value)}`);
                    break;
                default:
